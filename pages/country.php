...
require_once ("../php/operationCountry.php");
?>
    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                <div class="pt-2">
                    <?php inputElement("text","<i class='fas fa-id-badge'></i> ","disabled","ID", "c_id",$cid); ?>
                </div>
                <div class="pt-2">
                    <?php inputElement("text","<i class='fas fa-book'></i> *","required","Country Name", "c_name",$c_name); ?>
                </div>
...
?>
   ...
   <tr>
       ...
       <td>
   <a class="btn btn-outline-primary" href="../pages/country.php?edit= <?php echo $row['CountryID'] ?> ">edit</a>
   <a class="btn btn-danger btn-sm" href="../php/operationCountry.php?delete= <?php echo $row['CountryID'] ?>">delete</a>
   </td>
